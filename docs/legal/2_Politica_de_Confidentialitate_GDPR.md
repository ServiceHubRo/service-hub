...
### 2.1 Pentru orice cont

- numele, adresa de email, telefonul, limba (română sau engleză) și rolul (client sau service);
- codul contului (de exemplu `C-00012`), data creării contului, data confirmării emailului și data ultimei folosiri;
- versiunea Termenilor și a acestei politici pe care le-ai acceptat și data acceptării;
- parola, doar sub formă criptată (nici noi nu o putem citi);
- alegerile tale din aplicație (de exemplu, dacă ai amânat mesajul despre notificări).
...
| Pentru ce | Temeiul legal (art. 6 GDPR) |
|---|---|
...
## 4. Cine vede datele tale

### 4.1 Alți utilizatori
...
Lucrăm cu furnizori care prelucrează date doar la cererea noastră, pe baza unui contract de prelucrare (art. 28 GDPR):

| Furnizor | Pentru ce | Ce date | Unde |
|---|---|---|---|
...
Dăm date autorităților doar când legea ne obligă (de exemplu, la o cerere a instanței sau a ANAF).

---

## 5. Cât timp păstrăm datele

- **Cât ai contul:** datele contului, Garajul, programările, devizele, lucrările, recenziile și mesajele.
- **Când îți ștergi contul** (Cont → Datele mele → Șterge contul), ștergerea se face pe loc:
  - **Client:** se șterg contul, mașinile din Garaj, favoritele, dispozitivele pentru notificări și notificările netrimise. Numele și telefonul tău dispar din programări și din conversații. Rămân, fără numele și telefonul tău: lucrările din evidența service-urilor (mașina, lucrarea, costul, kilometrajul), recenziile (fără nume) și mesajele din conversațiile service-urilor. Rapoartele de istoric cumpărate rămân verificabile după cod; ele nu conțin numele tău.
...
- să **corectezi** datele greșite (numele, telefonul și mașinile le schimbi direct în aplicație);
...
Când actualizăm această politică schimbăm data de sus. Schimbările importante ți le anunțăm în aplicație sau pe email înainte să intre în vigoare.
