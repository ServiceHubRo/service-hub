...
| T19d | Remindere pentru clienți | Cerere de recenzie a doua zi, reminder de revizie (ulei, frână…) cu 2 săptămâni înainte |
...
Note: 1 migrare (`client_reminders`, `schema_version` = 29), niciun pachet nou. **Cererea de recenzie:** la 10:xx (ora României) pleacă un push „Cum a fost la Atelier X? Lasă o recenzie pentru schimb ulei…” pentru lucrările terminate ieri (dacă o rulare se pierde, le prinde a doua zi, până la 3 zile), o singură dată, doar dacă nu există recenzie și fereastra de 60 de zile e deschisă; atingerea deschide programarea cu formularul de recenzie deja deschis (`?p=…&recenzie=1`). Pe Caută, cardul „Cum a fost la …?” arată cea mai recentă lucrare fără recenzie (cât se mai poate lăsa); dispare după recenzie. **Reminderul de revizie:** serviciile din catalog au acum „Reminder de revizie (luni)” (Catalog de servicii → Editează; gol = fără). Pornite din migrare: ulei, revizie completă, filtru polen, igienizare climă, pregătire de iarnă, revizie GPL, ulei la domiciliu 12 luni; filtru aer, filtru combustibil, lichid de frână, încărcare climă 24; bujii, antigel 48; kit distribuție 60. La 10:xx, pentru fiecare mașină din garaj și fiecare serviciu cu interval, ultima lucrare de acel fel la acea mașină; când termenul (ziua lucrării + intervalul) e în următoarele 14 zile, un push „Se apropie termenul pentru schimb ulei + filtru ulei (ultima dată: oct 2025, la Atelier X). Programează-te din aplicație.”; atingerea deschide programarea la același service, cu serviciul ales și mașina bifată la pasul 4. O dată pe lucrare (o lucrare nouă repornește numărătoarea); nu dacă mașina are deja o programare activă pentru acel serviciu. **Cont → Remindere** (clienți): „Cerere de recenzie după lucrare” și „Remindere de revizie”, pornite implicit; prima oprește și cardul de pe Caută. Fără email. Textele se pot schimba din Texte notificări (admin). Politica de confidențialitate (RO + EN, §9) spune de ambele și de unde se opresc. **Decizii:** (1) reminderul se socotește per serviciu: o „Revizie completă” nu oprește reminderul „Schimb ulei” de dinainte (se poate lega mai târziu, dacă e cazul); (2) reminderul folosește mașina din garaj — o mașină ștearsă nu mai primește; (3) service-ul închis între timp: reminderul pleacă totuși, iar ecranul de programare spune că service-ul nu mai primește programări; (4) cardul de pe Caută nu are „Nu acum” (ar fi cerut încă o cheie în browser, trecută în Politica de cookies); îl ascunde bifa din Cont. Testat: SQL (`88_client_reminders.sql`: ora 10, o dată, fereastra, preferințele, suspendarea, mașina ștearsă, programarea activă, serviciul oprit, lucrarea nouă, drepturile adminului), unitare (texte RO/EN, linkuri, cardul, intervalul), în browser la 390/820/1440 în RO și EN (cardul, Cont → Remindere, linkul reminderului cu mașina bifată, intervalul în catalog și jurnalul de audit).
