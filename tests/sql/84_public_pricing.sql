...
-- the price per colleague, the included colleagues, the free trial days, the launch price and the
-- discounts for 3, 6 and 12 months, as currently set in Setări platformă.
begin;
